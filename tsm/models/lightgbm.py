...
joblib.dump(lgb_reg, 'data/objects/lgb_reg_met0_rmsle_{}.pkl'.format(overall_rmsle))
joblib.dump(list(zip(y_hat, y_ts)), 'data/objects/lgb_reg_met0_rmsle_{}_preds.pkl'.format(overall_rmsle))